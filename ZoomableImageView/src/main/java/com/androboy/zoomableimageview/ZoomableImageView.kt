package com.androboy.zoomableimageview
...
class ZoomableImageView : AppCompatImageView, View.OnTouchListener,
    ...
    private inner class ScalingListener : ScaleGestureDetector.SimpleOnScaleGestureListener() {
        ...
        override fun onScale(detector: ScaleGestureDetector): Boolean {
            ...
            if (originalWidth * presentScale <= mViewedWidth || originalHeight * presentScale <= mViewedHeight) {
                myMatrix!!.postScale(
                    mScaleFactor,
                    mScaleFactor,
                    mViewedWidth / 2.toFloat(),
